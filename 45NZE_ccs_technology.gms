...
set power_plants(TECHNOLOGY) / coal_pp, ccgt_pp, bio_pp, oil_pp, geothermal_pp, wind_pp,windOFF_pp, pv_pp, hydro_ror_pp, hydro_dam_pp, psh_pp, nuclear_pp, ccgt_ccs_pp/;
...
parameter OutputActivityRatio(r,t,f,m,y) /
  ...
  UTOPIA.ccgt_ccs_pp.wind.1.(2020*2060) 1
  UTOPIA.dacc.wind.1.(2020*2060) 1
...
parameter TotalAnnualMaxCapacity(r,t,y) /
  ...
  UTOPIA.coal_pp.(2020*2060) 10
  UTOPIA.ccgt_pp.(2020*2060) 44
  UTOPIA.oil_pp.(2020*2060) 4
  UTOPIA.geothermal_pp.(2020*2060) 40
  UTOPIA.wind_pp.(2020*2060) 20
  UTOPIA.windOFF_pp.(2020*2060) 40
  UTOPIA.pv_pp.(2020*2060)  40  
  UTOPIA.bio_pp.(2020*2060) 40
  UTOPIA.nuclear_pp.(2020*2060) 40
  
  UTOPIA.ccgt_ccs_pp.(2020*2060) 40
  UTOPIA.dacc.(2020*2060) 40
/;
...
parameter TotalAnnualMaxCapacityInvestment(r,t,y) /
  ...
  UTOPIA.coal_pp.(2020*2060) 0
  UTOPIA.ccgt_pp.(2020*2060) 0
  UTOPIA.oil_pp.(2020*2060) 0
  UTOPIA.geothermal_pp.(2020*2060) 1
  UTOPIA.wind_pp.(2020*2060) 1
  UTOPIA.windOFF_pp.(2020*2060) 1
  UTOPIA.pv_pp.(2020*2060) 1
  UTOPIA.bio_pp.(2020*2060) 1
...
*parameter EmissionActivityRationNeg(r,t,e,m,y) /
*    UTOPIA.dacc.CO2.1.(2020*2060)   0.05
*    /;
...
AnnualEmissionLimit(r,e,"2020")=100;
...
****** prova arimettere il vincolo di positività sulle variabili ****



*UTOPIA.coal_pp.CO2 0.5
*UTOPIA.ccgt_pp.CO2 0.5
*TOPIA.bio_pp.CO2 0.5
*UTOPIA.oil_pp.CO2 0.5
*UTOPIA.pv_pp.CO2 0.5
*TOPIA.hydro_dam_pp.CO2 0.5
*UTOPIA.hydro_ror_pp.CO2 0.5
*UTOPIA.psh_pp.CO2 0.5
*UTOPIA.geothermal_pp.CO2 0.5
*UTOPIA.wind_pp.CO2 0.5
*UTOPIA.windOFF_pp.CO2 0.0
*UTOPIA.nuclear.CO2 0.0
*/;
