...
loop(KONS,loop(y, if(KONS.val*10<=y.val-2020 and y.val-2020<KONS.val*10+5,CapacityFactor(r,'hydro_dam_pp','SPD',y) = (-0.0005*(y.val-2006)+0.50578);elseif KONS.val*10+5<=y.val-2020 and y.val-2020<KONS.val*10+10, CapacityFactor(r,'hydro_dam_pp','SPD',y) = (-0.0005*(y.val-2006)+0.23782) ; CapacityFactor(r,'ccgt_pp','SPD',y) = 0.85*0.8 );););
loop(KONS,loop(y, if(KONS.val*10<=y.val-2020 and y.val-2020<KONS.val*10+5,CapacityFactor(r,'hydro_dam_pp','SPN',y) = (-0.0005*(y.val-2006)+0.50578);elseif KONS.val*10+5<=y.val-2020 and y.val-2020<KONS.val*10+10, CapacityFactor(r,'hydro_dam_pp','SPN',y) = (-0.0005*(y.val-2006)+0.23782) ; CapacityFactor(r,'ccgt_pp','SPN',y) = 0.85*0.8 );););
loop(KONS,loop(y, if(KONS.val*10<=y.val-2020 and y.val-2020<KONS.val*10+5,CapacityFactor(r,'hydro_dam_pp','SD',y) = (-0.000005*(y.val-2006)+0.273763);elseif KONS.val*10+5<=y.val-2020 and y.val-2020<KONS.val*10+10, CapacityFactor(r,'hydro_dam_pp','SD',y) = (-0.000005*(y.val-2006)+0.128637) ; CapacityFactor(r,'ccgt_pp','SD',y) = 0.85*0.8 );););
loop(KONS,loop(y, if(KONS.val*10<=y.val-2020 and y.val-2020<KONS.val*10+5,CapacityFactor(r,'hydro_dam_pp','SN',y) = (-0.000005*(y.val-2006)+0.273763);elseif KONS.val*10+5<=y.val-2020 and y.val-2020<KONS.val*10+10, CapacityFactor(r,'hydro_dam_pp','SN',y) = (-0.000005*(y.val-2006)+0.128637) ; CapacityFactor(r,'ccgt_pp','SN',y) = 0.85*0.8 );););
