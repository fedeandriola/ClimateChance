...
loop(KONS,loop(y, if(KONS.val*10<=y.val-2020 and y.val-2020<KONS.val*10+5,CapacityFactor(r,'hydro_dam_pp','SPN',y) = (-0.0007*(y.val-2006)+0.50758);elseif KONS.val*10+5<=y.val-2020 and y.val-2020<KONS.val*10+10, CapacityFactor(r,'hydro_dam_pp','SPN',y) = (-0.0005*(y.val-2006)+0.23782) ; CapacityFactor(r,'ccgt_pp','SPN',y) = 0.85*0.7 );););
...
loop(KONS,loop(y, if(KONS.val*10<=y.val-2020 and y.val-2020<KONS.val*10+5,CapacityFactor(r,'hydro_ror_pp','SD',y) = (-0.0006*(y.val-2006)+0.527884);elseif KONS.val*10+5<=y.val-2020 and y.val-2020<KONS.val*10+10, CapacityFactor(r,'hydro_ror_pp','SD',y) = (-0.0016*(y.val-2006)+0.318116) ; CapacityFactor(r,'ccgt_pp','SD',y) = 0.85*0.7 );););
loop(KONS,loop(y, if(KONS.val*10<=y.val-2020 and y.val-2020<KONS.val*10+5,CapacityFactor(r,'hydro_ror_pp','SN',y) = (-0.0016*(y.val-2006)+0.527884);elseif KONS.val*10+5<=y.val-2020 and y.val-2020<KONS.val*10+10, CapacityFactor(r,'hydro_ror_pp','SN',y) = (-0.0016*(y.val-2006)+0.318116) ; CapacityFactor(r,'ccgt_pp','SN',y) = 0.85*0.7 );););
