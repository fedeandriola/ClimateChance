...
* emission]
 variable AnnualTechnologyEmissionByMode(REGION,TECHNOLOGY,EMISSION,MODE_OF_OPERATION,YEAR);

* AnnualTechnologyEmission[r,t,e,y] >=0: Sum of the
* AnnualTechnologyEmissionByMode over the modes of operation. [Quantity of
* emission]
 variable AnnualTechnologyEmission(REGION,TECHNOLOGY,EMISSION,YEAR);
...
* units]
 variable AnnualTechnologyEmissionPenaltyByEmission(REGION,TECHNOLOGY,EMISSION,YEAR);
...
* user defined ModelPeriodExogenousEmission. [Quantity of emission]
 variable ModelPeriodEmissions(EMISSION,REGION);
